...
1. "k-Deviation Search: A Reinforcement Learning Framework for Combinatorial
   Optimization"
...
- [ ] Post on Hacker News: "I built an RL algorithm that solves TSP without
      neural networks"
